package com.example.blackstone.bluetoothimpresora;
...
import com.example.command.sdk.Command;
import com.example.command.sdk.PrintPicture;
import com.example.command.sdk.PrinterCommand;
...
*/
        ...
        mTitle = (TextView) findViewById(R.id.prueba);
    ...
    public synchronized void onResume() {
        ...
        if (mService != null) {
            ...
            if (mService.getState() == BluetoothService.STATE_NONE) {
                ...
                if(DEBUG)Log.d("Activity","onResume");
                mService.start();
            }
        }
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.Send_Button:{
                if (hexBox.isChecked()) {
                    ...
                    if(str.length() > 0){
                        ...
                        Toast.makeText(MainActivity.this, getText(R.string.empty), Toast.LENGTH_SHORT).show();
                    }
                } else {
            ...
            case R.id.btn_printpicture:{
                Log.e("TAG", "onClick: printpicture");
                GraphicalPrint();
                break;
            }
...
/****************************************************************************************************/
    ...
    private void printBarCode() {
        ...
        new AlertDialog.Builder(MainActivity.this).setTitle(getText(R.string.btn_prtcode))
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(which == 0)
                        {
                            if(str.length() == 11 || str.length() == 12)
                            {
                                ...
                                Toast.makeText(MainActivity.this, getText(R.string.msg_error), Toast.LENGTH_SHORT).show();
                                return;
                            }
                        }
                        else if(which == 1)
                        ...
                        else if(which == 9)
                        {
                            if(str.length() == 0)
                            {
                                Toast.makeText(MainActivity.this, getText(R.string.empty1), Toast.LENGTH_SHORT).show();
                                return;
                            }
                            else
                            {
    ...
    private void CommandTest(){
        ...
        String lang = getString(R.string.strLang);
        if((lang.compareTo("cn")) == 0){
            new AlertDialog.Builder(MainActivity.this).setTitle(getText(R.string.chosecommand))
